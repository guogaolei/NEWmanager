...
public class AgreementLogsEntity {
	...
	String toFinisDate;//收票日期
	String finishDate;//付款日期
	...
	public String getToFinisDate() {
		return toFinisDate;
	}
	public void setToFinisDate(String toFinisDate) {
		this.toFinisDate = toFinisDate;
	}
